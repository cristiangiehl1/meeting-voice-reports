...
export function loadApiBaseUrl(storage: Pick<Storage, 'getItem'> = localStorage): string {
...
export function saveApiBaseUrl(raw: string, storage: Pick<Storage, 'setItem'> = localStorage): string {
